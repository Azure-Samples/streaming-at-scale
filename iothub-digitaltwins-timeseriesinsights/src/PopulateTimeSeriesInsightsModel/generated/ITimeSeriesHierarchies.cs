...
namespace Microsoft.Azure.TimeSeriesInsights
{
    ...
    /// </summary>
    public partial interface ITimeSeriesHierarchies
    {
        /// <summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<HttpOperationResponse<HierarchiesBatchResponse,TimeSeriesHierarchiesExecuteBatchHeaders>> ExecuteBatchWithHttpMessagesAsync(HierarchiesBatchRequest parameters, string clientRequestId = default(string), string clientSessionId = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
