...
public class StreamingJobCommon {
    ...
    static <T> FlinkKafkaConsumer011<T> createKafkaConsumer(ParameterTool params, KafkaDeserializationSchema<T> schema) {
        // set up the execution environment
        ...
        FlinkKafkaConsumer011 kafkaIn = new FlinkKafkaConsumer011(topicIn, schema, properties);
        return kafkaIn;
    }
    ...
    static void setProperties(ParameterTool params, String prefix, Properties properties) {
