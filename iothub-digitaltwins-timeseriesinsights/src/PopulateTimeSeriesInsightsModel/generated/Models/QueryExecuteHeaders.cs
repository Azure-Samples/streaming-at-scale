...
namespace Microsoft.Azure.TimeSeriesInsights.Models
{
    ...
    /// <summary>
    /// Defines headers for Execute operation.
    /// </summary>
    public partial class QueryExecuteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the QueryExecuteHeaders class.
        /// </summary>
        public QueryExecuteHeaders()
        {
            CustomInit();
        }
        ...
        public QueryExecuteHeaders(string serverRequestId = default(string))
        {
