...
namespace Microsoft.Azure.TimeSeriesInsights.Models
{
    ...
    /// </summary>
    public partial class ModelSettingsUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ModelSettingsUpdateHeaders class.
        /// </summary>
        public ModelSettingsUpdateHeaders()
        {
            CustomInit();
        }
        ...
        public ModelSettingsUpdateHeaders(string serverRequestId = default(string))
        {
