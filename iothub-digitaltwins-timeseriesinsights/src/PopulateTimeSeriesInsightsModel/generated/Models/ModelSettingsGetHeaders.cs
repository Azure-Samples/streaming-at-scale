...
namespace Microsoft.Azure.TimeSeriesInsights.Models
{
    ...
    /// </summary>
    public partial class ModelSettingsGetHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ModelSettingsGetHeaders class.
        /// </summary>
        public ModelSettingsGetHeaders()
        {
            CustomInit();
        }
        ...
        public ModelSettingsGetHeaders(string serverRequestId = default(string))
        {
