...
def get_kusto_mgnt_client(client_id: str, client_secret: str, tenant_id: str, sub_id,
                     region: str, cluster_name: str) -> KustoClient:
...
def cleanup_all_db_table_records(kusto_client: KustoClient, database: str) -> None:
...
if __name__ == '__main__':
    ...
    for db in db_list_result:
        ...
        cleanup_all_db_table_records(kusto_client, entry_database)

    print('Done cleaning up extents')
