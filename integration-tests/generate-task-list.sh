...
generate_test_jobs eventhubs-databricks-cosmosdb                   edc2  CIDPTMV  20  "1"
generate_test_jobs eventhubs-databricks-delta                      edd1  CIPTMV   20  "1 10"
generate_test_jobs eventhubs-databricks-delta                      edd2  CIPTMV   20  "1"
generate_test_jobs eventhubs-functions-azuresql                    efa1  CIDPTMV  10  "1 10"     "k" "rowstore"
generate_test_jobs eventhubs-functions-azuresql                    efa2  CIDPTMV  10  "1"        "k" "rowstore-inmemory columnstore-inmemory"
...
generate_test_jobs eventhubs-streamanalytics-cosmosdb              esc2  CIDPTMV  10  "1"
