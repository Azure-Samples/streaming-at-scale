...
namespace Microsoft.Azure.TimeSeriesInsights
{
    ...
    /// <summary>
    /// Extension methods for TimeSeriesTypes.
    /// </summary>
    public static partial class TimeSeriesTypesExtensions
    {
            /// <summary>
            ...
            /// </param>
            public static async Task<GetTypesPage> ListAsync(this ITimeSeriesTypes operations, string continuationToken = default(string), string clientRequestId = default(string), string clientSessionId = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
