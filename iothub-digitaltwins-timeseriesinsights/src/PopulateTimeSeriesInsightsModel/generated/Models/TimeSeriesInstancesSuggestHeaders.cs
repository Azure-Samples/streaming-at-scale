...
namespace Microsoft.Azure.TimeSeriesInsights.Models
{
    ...
    /// <summary>
    /// Defines headers for Suggest operation.
    /// </summary>
    public partial class TimeSeriesInstancesSuggestHeaders
    {
        /// <summary>
        /// Initializes a new instance of the TimeSeriesInstancesSuggestHeaders
        /// class.
        /// </summary>
        public TimeSeriesInstancesSuggestHeaders()
        {
            CustomInit();
        }
        ...
        public TimeSeriesInstancesSuggestHeaders(string serverRequestId = default(string))
        {
